...
class Player(object):
    ...
    def movePlayer(self, key_map):
        ...
        if key_map["cam_left"]:    # Kamera nach links drehen, wenn die Taste gedrÃŒckt wurde
            base.camera.setX(base.camera, +20 * globalClock.getDt())
        if key_map["cam_right"]:   # Kamera nach links drehen, wenn die Taste gedrÃŒckt wurde
            base.camera.setX(base.camera, -20 * globalClock.getDt())
