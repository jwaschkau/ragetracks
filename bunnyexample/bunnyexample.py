...
## Kommentar entfernen fÃŒr Vollbildmodus
...
from direct.showbase.DirectObject import DirectObject       # Basisklasse fÃŒr das Spiel
...
#        self.properties.setSize(1280, 1024)
    ...
    def loadLevel(self, filename):
        ...
        model = start_point.getTag("model") # Das Model ist abhÃ€ngig von der Variable im Level
        ...
        # die Bewegungsfunktion zum Taskmanager hnzufÃŒgen
